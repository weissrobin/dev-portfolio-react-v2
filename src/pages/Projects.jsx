...
const Projects = () => {
    ...
    return (
        <div className={`text-right flex flex-col overflow-auto max-h-full gap-10 no-scrollbar mt-auto opacity-0 ${revealed ? 'animate-reveal' : ''}`}>
            <ProjectItem name='MstyleStudio' purpose='Bachelor Project' url='https://mstyles.netlify.app' technologies='Webpack / SCSS / JS,JQ / SQL' />
            ...
            <ProjectItem name='CzechProject' purpose='CzechProject s.r.o.' url='https://czechproject.cz/' technologies='Bootstrap / PHP / HTML / SCSS / Lottie' />
