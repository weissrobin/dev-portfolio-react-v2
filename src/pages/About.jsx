...
const About = () => {
    ...
    return (
        <div className={`text-left text-sm font-neue overflow-auto no-scrollbar xl:text-left xl:m-auto xl:text-[14px] md:w-[700px]  ${revealed ? 'animate-reveal' : ''}`}>
            <p className=" ml-auto">Hey there! I'm a self-taught React developer with four years of experience in web technologies. 
            ...
            <p className="ml-auto">On this website, you'll find a showcase of the work I've completed, reflecting my dedication 
